-- DropIndex
DROP INDEX "JobPosting_normalizedLocation_trgm_idx";

-- DropIndex
DROP INDEX "JobPosting_normalizedTitle_trgm_idx";

-- DropIndex
DROP INDEX "JobPosting_searchDocumentNormalized_trgm_idx";
