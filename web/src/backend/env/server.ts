...
const schema = z
  .object({
    ...
    OCR_SEARCH_ADAPTIVE_TILING_ENABLED: booleanString.optional(),
    OCR_SEARCH_TILE_OVERLAP_PERCENT: z.string().optional(),
    OCR_SEARCH_TILE_BATCH_SIZE: z.string().optional(),
    OCR_SEARCH_MAX_TILES: z.string().optional(),
    OCR_SEARCH_STRATEGY_VERSION: z.string().optional(),
