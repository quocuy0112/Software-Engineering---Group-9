    ...
    <Html>
      ...
      <Body style={{ backgroundColor: "#f4f7f2", fontFamily: "Arial, sans-serif" }}>
        <Container style={{ backgroundColor: "#fff", margin: "32px auto", maxWidth: "560px", padding: "32px" }}>
          ...
          <Button href={invitationUrl} style={{ backgroundColor: "#2457d6", borderRadius: "8px", color: "#fff", padding: "12px 18px" }}>
            Accept invitation
          </Button>
          <Text>This secure link can be used once and expires in seven days.</Text>
          <Text>If you were not expecting this invitation, you can safely ignore this email.</Text>
        </Container>
      </Body>
    </Html>
  );
