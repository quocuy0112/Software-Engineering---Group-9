...
export function PrivateMatchDeleteControl({
  ...
  return (
    <div className={compact ? "private-match-delete-control is-compact" : "private-match-delete-control"}>
      <button
      ...
      >
        <Trash2 aria-hidden="true" /> {compact ? "Delete" : "Delete this preview"}
      </button>
      {open ? (
        <div
          ...
          role="presentation"
          onMouseDown={(event) => {
            if (event.target === event.currentTarget && !deletion.isPending) {
              setOpen(false);
            }
          }}
        >
          ...
          >
            <header>
              <div className="private-match-modal-icon"><TriangleAlert aria-hidden="true" /></div>
              <div>
                <h2 id={`delete-private-match-title-${checkId}`}>Delete this private preview?</h2>
            ...
            <div className="private-match-modal-privacy">
              ...
              <span>This action only removes your private CV Match Check report.</span>
            </div>
            {deletion.isError ? (
            ...
            <div className="private-match-modal-actions">
              ...
              <button
                ...
                disabled={deletion.isPending}
              >
                <Trash2 aria-hidden="true" /> {deletion.isPending ? "Deleting…" : "Delete preview"}
              </button>
            </div>
          </section>
        </div>
