...
import { candidateViewer, employerViewer } from "../../../helpers/home/home-fixtures";

describe("Home personal shortcuts", () => {
  it("gives candidates only the approved existing shortcuts", () => {
    render(<HomePersonalShortcuts viewer={candidateViewer} copy={homeCopy.en} />);
  ...
  it("does not guess a Post a Job destination when recruiter status is unavailable", () => {
    ...
    expect(screen.getByText(/Status unavailable/u)).toHaveAttribute("aria-disabled", "true");
  });
});
