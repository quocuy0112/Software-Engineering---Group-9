...
const recoveryFiles = [
  ...
  "src/server/services/identity/authorize-account-recovery-route.ts",
  ...
  "src/lib/security/account-recovery-capability.ts",
  "src/features/identity/client/use-account-recovery-capability.ts",
];
