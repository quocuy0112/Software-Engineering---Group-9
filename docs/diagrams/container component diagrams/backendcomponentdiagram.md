...
graph TD
    ...
    AuthGateway -->|"Prisma — read/write\nauth-owned tables"| PostgreSQL
    Repositories -->|"Prisma — query\nand transaction"| PostgreSQL
...
- **Technology:** Prisma 7.
- **Relationships:** Called by Identity/Profile/Job/CV/Image services; queries/transactions directly on `PostgreSQL` via Prisma.
...
graph TD
    ...
    CvRuntime -->|"Prisma — claim/update\nCV work and lease"| PostgreSQL
    ...
    ImageRuntime -->|"Prisma — claim/update\nimage-search stage"| PostgreSQL
