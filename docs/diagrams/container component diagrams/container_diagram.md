...
**Architecture scope:** Implemented baseline Features 001–005. The diagram includes every deployable runtime and logical data store currently required by those features.
...
### 11. External Services — optional unless noted
