...
| V1.4    | 2026-08-26 | Lưu Chí Hải | Replaced mixed scope with complete evidence-based communication, safety, notification, and recruitment-thread specifications; moved scoring/analytics to their correct logical domains. | Nguyễn Minh Khôi |
| V1.5    | 2026-08-26 | Lưu Chí Hải | Linked valid notification prototypes for UC-NOT-01–02 and explicitly recorded missing screenshot evidence for the remaining PA5 communication use cases. | Nguyễn Minh Khôi |
