...
# Use-Case Specification: UC-ORG-01 — Submit Company Verification Request
...
# Use-Case Specification: UC-ORG-02 — Request to Join Existing Company
...
# Use-Case Specification: UC-ORG-03 — Review Company or Membership Request
...
# Use-Case Specification: UC-ORG-04 — Manage Company Memberships and Roles
...
# Use-Case Specification: UC-ORG-05 — Manage Membership Lifecycle
...
# Use-Case Specification: UC-USER-01 — Search and View User Accounts
...
# Use-Case Specification: UC-USER-02 — Apply Account Enforcement Action
...
# Use-Case Specification: UC-MOD-01 — Review Submitted Job Posting
...
# Use-Case Specification: UC-MOD-02 — Approve, Reject, or Request Revision
...
# Use-Case Specification: UC-MOD-03 — Investigate Job Report
