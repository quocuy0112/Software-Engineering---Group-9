...
The project deliverables and their planning status based on the latest PA5 evidence are:

| ID | Deliverable | Related Tasks | Status at Latest PA5 Evidence |
|---|---|---|---|
...
The primary roles above remain the team baseline. The latest Sprint 5 allocation records Uy upgrading the overall UI and building minor features after completing the landing-page, planning/UI, and Feature Group 9 work; Thành handling the Recruiter job-posting flow, the separate Admin approval flow for Recruiter job posts, Admin feature logic, and data backup after completing the initial messaging and Admin work; Tuấn completing Recruiter feature logic after completing Recruiter foundations, RBAC/scoring work, and specifications for Feature Groups 5, 7, and 12; Hải maintaining the Project Plan and assigned diagrams and producing the Feature Group 8 — Kanban specification after completing the PA5 Weekly Report and testing research; and Khôi updating his assigned architecture diagrams, supporting testing, and assisting Thành with Admin notification email formatting and user-facing content. These sprint assignments supplement rather than permanently replace the primary roles.
...
- The latest Sprint 5 report does not name reviewers for its newly assigned work. Reviewers remain `TBD`; task-level dates are recorded only where the supporting Notion evidence provides them.
...
The project follows Scrum and is divided into five sprints. Sprint dates, tasks, owners, reviewers, and acceptance criteria must be maintained consistently in this document and in Notion. The status below is based on the latest available Weekly Report, dated 12-08-2026, read after the 09-08 checkpoint, together with the supporting Notion and task-assignment evidence referenced by the report.
...
Sprint 5 is in progress. The 12-08-2026 Weekly Report supersedes the 09-08 checkpoint where it records completed initial work, new assignments, and the transfer of Feature Group 8 — Kanban from Tuấn to Hải. It records S5-01A, S5-02A, S5-03A, S5-04A, and S5-05A as completed. Supporting Notion evidence additionally records S5-02B and S5-02C as completed, while S5-01B, S5-03B, and the Project Plan/diagram portion of S5-04B are in progress. S5-04B's Kanban specification and S5-05B remain assigned/current work without completion evidence. Completed initial work and unfinished follow-up work are separated below so that later assignments are not represented as part of an already completed task. Unconfirmed reviewers and dates remain `TBD`.

| ID | Task and Expected Output | Owner | Reviewer | Start | Due | Acceptance Criteria |
| -- | ------------------------ | ----- | -------- | ----- | --- | ------------------- |
| S5-01A | Build the Landing Home Page, prepare Sprint 5 planning, apply the planned UI work, and generate Spec Kit specifications for Feature Group 9, **Automated Notifications & In-App Alerts**. | Nguyễn Gia Quốc Uy | TBD | TBD | TBD | The landing page and UI/planning work are delivered, and the Feature Group 9 specification artifacts are complete and consistent with the Vision's P0 notification scope. |
| S5-01B | Upgrade the overall UI and build additional minor features. | Nguyễn Gia Quốc Uy | TBD | 16-08-2026 | 23-08-2026 | The overall UI is upgraded and the assigned minor features are implemented and verified without introducing unsupported scope. |
| S5-02A | Build Chat Messaging; establish the base platform-administrator functionality; implement administrator review of recruiter/company access; and generate specifications for Feature Groups 10 and 11. | Nguyễn Quốc Thành | TBD | TBD | TBD | Base administrator functionality, the recruiter/company-access approval workflow, and the Feature Groups 10 and 11 specification artifacts are complete. Chat Messaging remains subject to the scope and traceability clarification recorded in this plan. |
| S5-02B | Build the Recruiter job-posting flow and the separate Admin-side approval flow for job posts created by Recruiters. | Nguyễn Quốc Thành | TBD | 14-08-2026 | 16-08-2026 | Recruiters can create job posts and authorized administrators can review those posts through a distinct job-post approval workflow. |
| S5-02C | Complete the Admin feature logic and implement data backup. | Nguyễn Quốc Thành | TBD | 17-08-2026 | 23-08-2026 | The assigned Admin logic and data-backup work are implemented and verified. |
| S5-03A | Establish recruiter/company-member functionality; enforce RBAC boundaries between company-scoped recruiter permissions and the separate platform-administrator role; build advisory scoring for recruiter and candidate views; and generate specifications for Feature Groups 5, 7, and 12. | Ngô Quốc Tuấn | TBD | TBD | TBD | Recruiter/company-member foundations and RBAC/scoring work are delivered, and the Feature Groups 5, 7, and 12 specification artifacts are complete. Feature Group 8 is excluded because it was transferred to Hải. |
| S5-03B | Complete the logic for Recruiter features. | Ngô Quốc Tuấn | TBD | 16-08-2026 | 23-08-2026 | The remaining Recruiter feature logic is implemented and verified while preserving company scope, resource ownership, and the separate administrator boundary. |
| S5-04A | Write the PA5 Weekly Report and research the Test Plan and test cases for the entire system. | Lưu Chí Hải | TBD | TBD | TBD | The Weekly Report contains the required meeting and task evidence, and the research identifies the system-wide test-planning and test-case approach. |
...
| Build | Target Date | Included Scope | Exit Criteria | Status at Latest PA5 Evidence |
|---|---|---|---|---|
...
| The recruitment pipeline uses nine canonical stages. | Pipeline backend, application tracking, specifications, and tests use the same stages; S5-04B assigns the Feature Group 8 — Kanban specification to Hải following its transfer from Tuấn. |
