...
Scope: verify how pinned Better Auth 1.6.11 persists TOTP secrets and backup codes, confirm
...
- [x] Storage model confirmed by source inspection of pinned Better Auth 1.6.11.
