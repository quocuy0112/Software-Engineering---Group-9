...
$expectedFeature = Join-Path $expectedRepo 'src/specs/001-identity-authentication-account-recovery'
...
try {
    $env:SPECIFY_FEATURE_DIRECTORY = 'src/specs/001-identity-authentication-account-recovery'
