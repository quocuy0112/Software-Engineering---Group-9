...
- Exact pins: Next.js 16.2.11, Better Auth and its Prisma adapter 1.6.25, Prisma/client 7.9.0, ESLint 10.8.0, Resend 6.17.2, Nodemailer 9.0.3, and @types/nodemailer 8.0.1; all resolve from the root lockfile.
...
Before implementation is accepted, inspect and test Better Auth 1.6.25 primary schema/source behavior for:
