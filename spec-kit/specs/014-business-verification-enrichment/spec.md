...
- **FR-020**: Requested company membership role MUST be one of `OWNER`, `HR_MANAGER`, `RECRUITER`, or `HIRING_MANAGER` and remain constrained by existing Feature 006 new-company and existing-company rules; a new company approval grants OWNER regardless of a client-supplied role.
