...
| FR-051 Profile-aware initial Add/Replace defaults, valid choices, saved-choice preservation, and per-entry/per-skill review | T068-T070, T073, T075-T086 | US2 focused comparison (5/5), review, and full uninterrupted E2E — PASS |
| FR-052 Profile duplicate hints plus in-draft skill/link duplicates never apply before confirmation | T040, T058, T069, T078, T085 | US1, US2 focused comparison — PASS |
