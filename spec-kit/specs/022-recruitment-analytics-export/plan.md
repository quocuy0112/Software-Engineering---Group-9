...
| Deterministic core and explainable AI | PASS | Export reads the current published screening result without recalculation; missing/limited scores remain explicit and no score drives a decision. Existing 60/40 policy and provenance remain authoritative. |
