...
- [X] T014 Create the additive schema/data migration, indexes, partial uniqueness rules including verification-event EmailOutbox idempotency, legacy JobReport category mapping, and reversible verification checks in `web/prisma/migrations/016_admin_management/migration.sql` (FR-034, FR-035, FR-037, FR-046, FR-048, FR-058, FR-061)
